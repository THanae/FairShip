...
/** Configuration macro for setting common cuts and processes for G3, G4 and
   Fluka (M. Al-Turany 27.03.2008) specific cuts and processes to g3 or g4
   should be set in the g3Config.C, g4Config.C or flConfig.C
...
void SetCuts() {
  ...
  // 2. set the following cut values: CUTGAM, CUTELE, CUTNEU, CUTHAD, CUTMUO = 1
  // MeV or less
  //                                  BCUTE, BCUTM, DCUTE, DCUTM, PPCUTM = 10
  //                                  TeV
  // (For an explanation of the chosen values, please refer to the GEANT User's
  // Guide or to message #5362 in the PandaRoot Forum >> Monte Carlo Engines >>
  // g3Config.C thread)
  //
  // The default settings refer to a complete simulation which generates and
  // follows also the secondary particles.
